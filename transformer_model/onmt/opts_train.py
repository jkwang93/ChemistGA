class OPT_TRAIN:
    def __init__(self, data = 'data/USPTO-50K_rm/USPTO-50K_rm', reverse = False):
        self.accum_count=4
        ...
        self.save_model='experiments/checkpoints/USPTO-50K_rm/USPTO-50K_model'
        self.seed=42
        ...
        self.train_from='experiments/checkpoints/USPTO-50K_rm/USPTO-50K_model_step_180000.pt'
        ...
        if reverse:
            data = 'data/USPTO-50K_rm-reverse/USPTO-50K_rm-reverse'
            self.data = data
