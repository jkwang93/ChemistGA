class OPT_PREPROCESS:
    def __init__(self, train_src = 'data/USPTO-50K_rm/src-train.txt', train_tgt ='data/USPTO-50K_rm/tgt-train.txt', \
        save_data = 'data/USPTO-50K_rm/USPTO-50K_rm', valid_src = 'data/USPTO-50K_rm/src-val.txt', valid_tgt = 'data/USPTO-50K_rm/tgt-val.txt', reverse = False):
        self.data_type='text'
        ...
        if reverse:
            train_src = 'data/USPTO-50K_rm-reverse/src-train.txt'
            train_tgt = 'data/USPTO-50K_rm-reverse/tgt-train.txt'
            save_data = 'data/USPTO-50K_rm-reverse/USPTO-50K_rm-reverse'
            valid_src = 'data/USPTO-50K_rm-reverse/src-val.txt'
            valid_tgt = 'data/USPTO-50K_rm-reverse/tgt-val.txt'
